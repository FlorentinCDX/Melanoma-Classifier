...
(async function () {
	...
	model = await tf.loadModel('https://skin-lesion-analyzer.000webhostapp.com/final_model_kaggle_version1/model.json');
	$("#selected-image").attr("src", "https://skin-lesion-analyzer.000webhostapp.com/assets/samplepic.jpg");
